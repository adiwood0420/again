...
//			TaskFormData taskFormData = formService.getTaskFormData("");
//			
//			taskFormData.getFormKey();
...
//												ResponseUtil.write(response, result);
												ResponseUtil.write(response, commentList);
...
//						if(currentGroup.getName().equals("CEO")||currentGroup.getName().equals("ViceCEO")){
							if(state==1 && (currentGroup.getName().equals("CEO")||currentGroup.getName().equals("ViceCEO"))){
