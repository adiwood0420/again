...
<script type="text/javascript">
	...
	function logout(){
		...
		$.messager.confirm("Messager","Are you sure to quit ?",function(r){
			if(r){
...
<div region="center" >
	...
	<div class="easyui-tabs" fit="true" border="false" id="tabs">
		<div title="首页" data-options="iconCls:'icon-home',closable:true">
	...
	<script type="text/javascript">
		$('#tabs').tabs({
			...
			onBeforeClose:function(title){
				return confirm("Are you sure to close "+title+" ? ");
			}
		})
	</script>
...
<div region="west" style="width: 200px;" title="Guide Menu" split="true">

	<div class="easyui-accordion" data-options="fit:true,border:false">
	
<%-- 	    <c:if test="${currentMemberShip.group.name=='Administrator' }">
			<div title="Basic Data Management" data-options="selected:true,iconCls:'icon-item'" style="padding: 10px">
			...
			<div title="Process Management"  data-options="iconCls:'icon-flow'" style="padding:10px;">
		...
		<c:if test="${currentMemberShip.group.name!='Employee'}">
			<div title="Task Management" data-options="iconCls:'icon-task'" style="padding:10px">
		...
		<c:choose>
			...
			<c:when test="${currentMemberShip.group.name=='Employee'}">
				<div title="Affair Management"  data-options="iconCls:'icon-yewu'" style="padding:10px">
			...
			<c:when test="${currentMemberShip.group.name=='Administrator' }">
				<div title="Basic Data Management" data-options="selected:true,iconCls:'icon-item'" style="padding: 10px">
					<a href="javascript:openTab('用户管理','userManage.jsp','icon-user')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-user'" style="width: 150px">用户管理</a>
					<a href="javascript:openTab('角色管理','groupManage.jsp','icon-role')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-role'" style="width: 150px">角色管理</a>
					<a href="javascript:openTab('用户权限管理','authManage.jsp','icon-power')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-power'" style="width: 150px">用户权限管理</a>
...
<%-- 		<c:if test="${currentMemberShip.group.name=='Employee'}">
		...
		<div title="System Management"  data-options="iconCls:'icon-system'" style="padding:10px">
