...
<script type="text/javascript">
	...
	function submit(state){
		...
		$("#fm").form("submit",{
			url:'${pageContext.request.contextPath}/task/audit_bz.action?state='+state,
					/* have action or not is ok , / web.xml ? */
	...
	$(function(){
		...
		$.post("${pageContext.request.contextPath}/leave/getLeaveByTaskId.action",{taskId:<%=request.getParameter("taskId")%>},function(result){
/* 			'${param.taskId}' */
...
<div id="p" class="easyui-panel" title="Chargeman Audit" style="width: 700px;height: 280px;padding: 10px">
	...
	<form id="fm" method="post">
		...
		<table cellspacing="8px">
			...
			<tr>
				...
				<td colspan="4">
					<a href="javascript:submit(1)" class="easyui-linkbutton" iconCls="icon-ok" >Approve</a>&nbsp;&nbsp;
					<a href="javascript:submit(2)" class="easyui-linkbutton" iconCls="icon-no" >Disapprove</a>
				</td>
			</tr>
		</table>
